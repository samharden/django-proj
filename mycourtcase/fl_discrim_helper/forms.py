...
# ##Gonna need some imports##
# from django import forms
# from django.forms import ChoiceField
#
# class frontpage(forms.Form):
#     complaint_or_search = ChoiceField('complaint_or_search', front_choices=[('complaint','Begin FCHR Complaint'),
...
#     complaintant_lastname = TextField('complaintant_lastname', )
