...
def workplace_complaint_assistant():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('workplace_complaint'))
    else:
        pass

    return render_template('workplace-complaint-assistant.html',
                           title='Workplace Access Builder.html',
                           form=form
                           )


def workplace_complaint():
    form = emp_disc
    ...
    return render_template('workplace-complaint.html',
